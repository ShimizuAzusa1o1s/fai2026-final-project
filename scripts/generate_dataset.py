"""
Training Data Generator for the Rollout Policies.
...
saved as a pickled list of dicts to ``results/dataset.pkl`` and is consumed by
training scripts.
...
if __name__ == "__main__":
    ...
    print("Saved dataset to results/dataset.pkl")
