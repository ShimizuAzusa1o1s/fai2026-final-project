...
def train_model(dataset_path="data/dataset_l3.npz", epochs=50, batch_size=256, lr=1e-3, save_name="weights_l3.pth"):
...
if __name__ == "__main__":
    ...
    parser.add_argument("--data", type=str, default="data/dataset_l3.npz")
    parser.add_argument("--epochs", type=int, default=50)
    parser.add_argument("--batch", type=int, default=256)
    parser.add_argument("--lr", type=float, default=1e-3)
    parser.add_argument("--out", type=str, default="weights_l3.pth")
    args = parser.parse_args()
    train_model(dataset_path=args.data, epochs=args.epochs, batch_size=args.batch, lr=args.lr, save_name=args.out)
