...
def generate_games(num_games=10, save_path="data/dataset_l3.npz"):
    print(f"Generating {num_games} games using a mixed pool for Level 3 trainer...")
...
if __name__ == "__main__":
    ...
    parser.add_argument("--out", type=str, default="data/dataset_l3.npz")
